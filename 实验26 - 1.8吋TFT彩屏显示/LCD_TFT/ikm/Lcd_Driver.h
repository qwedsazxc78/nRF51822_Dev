...
SCK P0.16 --- 时钟
****************************************/
#define   LCD_CS     22  //LCD_TFT片选
#define   LCD_RST    23  //LCD_TFT复位
#define   LCD_RS     24  //LCD_TFT数据/命令切换
#define   LCD_SDA    25  //LCD_TFT数据
#define   LCD_CLK    26  //LCD_TFT时钟
...
//LCD_RS//dc  
#define LCD_RS_SET     nrf_gpio_pin_set(LCD_RS)
#define LCD_RS_CLR     nrf_gpio_pin_clear(LCD_RS) 

//LCD_CS  
#define LCD_CS_SET     nrf_gpio_pin_set(LCD_CS)
#define LCD_CS_CLR     nrf_gpio_pin_clear(LCD_CS)

//LCD_CS  
#define LCD_SDA_SET    nrf_gpio_pin_set(LCD_SDA)
#define LCD_SDA_CLR    nrf_gpio_pin_clear(LCD_SDA)

//LCD_CS  
#define LCD_CLK_SET    nrf_gpio_pin_set(LCD_CLK)
#define LCD_CLK_CLR    nrf_gpio_pin_clear(LCD_CLK)
